  ...
  var require_dist = __commonJS((exports) => {
    ...
    var require_common = __commonJS2((exports2) => {
      ...
      function equals(a2, b) {
        return Math.abs(a2 - b) <= EPSILON * Math.max(1, Math.abs(a2), Math.abs(b));
      }
      if (!Math.hypot)
        Math.hypot = function() {
    ...
    var require_mat2 = __commonJS2((exports2) => {
      ...
      function multiplyScalarAndAdd(out, a2, b, scale2) {
        out[0] = a2[0] + b[0] * scale2;
        out[1] = a2[1] + b[1] * scale2;
        out[2] = a2[2] + b[2] * scale2;
        out[3] = a2[3] + b[3] * scale2;
        return out;
      }
      var mul2 = multiply;
      exports2.mul = mul2;
    ...
    var require_mat2d = __commonJS2((exports2) => {
      ...
      function fromValues(a2, b, c, d, tx, ty) {
        var out = new glMatrix.ARRAY_TYPE(6);
        out[0] = a2;
        out[1] = b;
        out[2] = c;
      ...
      function frob(a2) {
        return Math.hypot(a2[0], a2[1], a2[2], a2[3], a2[4], a2[5], 1);
      }
      function add(out, a2, b) {
        out[0] = a2[0] + b[0];
        out[1] = a2[1] + b[1];
      ...
      function multiplyScalarAndAdd(out, a2, b, scale2) {
        ...
        out[2] = a2[2] + b[2] * scale2;
        out[3] = a2[3] + b[3] * scale2;
        out[4] = a2[4] + b[4] * scale2;
        out[5] = a2[5] + b[5] * scale2;
        return out;
      }
      function exactEquals(a2, b) {
    ...
    var require_mat3 = __commonJS2((exports2) => {
      ...
      function translate(out, a2, v2) {
        var a00 = a2[0], a01 = a2[1], a02 = a2[2], a10 = a2[3], a11 = a2[4], a12 = a2[5], a20 = a2[6], a21 = a2[7], a22 = a2[8], x = v2[0], y = v2[1];
        out[0] = a00;
        out[1] = a01;
        out[2] = a02;
        out[3] = a10;
      ...
      function multiplyScalarAndAdd(out, a2, b, scale2) {
        ...
        out[4] = a2[4] + b[4] * scale2;
        out[5] = a2[5] + b[5] * scale2;
        out[6] = a2[6] + b[6] * scale2;
        out[7] = a2[7] + b[7] * scale2;
        out[8] = a2[8] + b[8] * scale2;
        return out;
      }
      function exactEquals(a2, b) {
    ...
    var require_mat4 = __commonJS2((exports2) => {
      ...
      function multiplyScalarAndAdd(out, a2, b, scale2) {
        ...
        out[7] = a2[7] + b[7] * scale2;
        out[8] = a2[8] + b[8] * scale2;
        out[9] = a2[9] + b[9] * scale2;
        out[10] = a2[10] + b[10] * scale2;
        out[11] = a2[11] + b[11] * scale2;
        out[12] = a2[12] + b[12] * scale2;
        out[13] = a2[13] + b[13] * scale2;
        out[14] = a2[14] + b[14] * scale2;
        out[15] = a2[15] + b[15] * scale2;
        return out;
      }
      function exactEquals(a2, b) {
    ...
    var require_vec3 = __commonJS2((exports2) => {
      ...
      function random2(out, scale2) {
        scale2 = scale2 || 1;
        var r2 = glMatrix.RANDOM() * 2 * Math.PI;
    ...
    var require_quat = __commonJS2((exports2) => {
      ...
      var rotationTo = function() {
        ...
        return function(out, a2, b) {
          var dot2 = vec33.dot(a2, b);
          if (dot2 < -0.999999) {
            vec33.cross(tmpvec3, xUnitVec3, a2);
            if (vec33.len(tmpvec3) < 1e-6)
              vec33.cross(tmpvec3, yUnitVec3, a2);
    ...
    var require_quat2 = __commonJS2((exports2) => {
      ...
      function fromMat4(out, a2) {
        ...
        mat42.getRotation(outer, a2);
        var t = new glMatrix.ARRAY_TYPE(3);
        mat42.getTranslation(t, a2);
      ...
      function translate(out, a2, v2) {
        var ax1 = a2[0], ay1 = a2[1], az1 = a2[2], aw1 = a2[3], bx1 = v2[0] * 0.5, by1 = v2[1] * 0.5, bz1 = v2[2] * 0.5, ax2 = a2[4], ay2 = a2[5], az2 = a2[6], aw2 = a2[7];
        out[0] = ax1;
        out[1] = ay1;
        out[2] = az1;
        out[3] = aw1;
      ...
      function rotateAroundAxis(out, a2, axis, rad) {
    ...
    var Vector3 = class extends V3Constructor {
      ...
      plus(v2) {
        return vec3.plus(this, this, v2);
      }
      minus(v2) {
        return vec3.minus(this, this, v2);
      }
      mul(v2) {
        return vec3.mul(this, this, v2);
      }
      div(v2) {
        return vec3.div(this, this, v2);
      }
      dot(v2) {
      ...
      static math(func) {
        return (...args) => {
          return vec3(func(...args.map((v2) => v2.x)), func(...args.map((v2) => v2.y)), func(...args.map((v2) => v2.z)));
        };
      }
    ...
    vec3.normalize = wrapGlMatrix(import_gl_matrix.vec3.normalize, 1, vec3.zero);
    vec3.inverse = wrapGlMatrix(import_gl_matrix.vec3.inverse, 1, vec3.zero);
    vec3.negate = wrapGlMatrix(import_gl_matrix.vec3.negate, 1, vec3.zero);
    vec3.plus = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] + b;
        out[1] = a2[1] + b;
        out[2] = a2[2] + b;
    ...
    vec3.minus = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] - b;
        out[1] = a2[1] - b;
        out[2] = a2[2] - b;
    ...
    vec3.mul = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] * b;
        out[1] = a2[1] * b;
        out[2] = a2[2] * b;
    ...
    vec3.div = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] / b;
        out[1] = a2[1] / b;
        out[2] = a2[2] / b;
    ...
    vec3.set = wrapGlMatrix((out, v2) => {
      out[0] = v2[0];
      out[1] = v2[1];
      out[2] = v2[2];
      return out;
    }, 1, vec3.zero);
    vec3.fill = wrapGlMatrix((out, n2) => {
      out[0] = out[1] = out[2] = n2;
      return out;
    }, 1, vec3.zero);
    vec3.distance = (u, v2) => Math.hypot(u.x - v2.x, u.y - v2.y, u.z - v2.z);
    ...
    var Vector4 = class extends V4Constructor {
      ...
      plus(v2) {
        return vec4.plus(this, this, v2);
      }
      minus(v2) {
        return vec4.minus(this, this, v2);
      }
      mul(v2) {
        return vec4.mul(this, this, v2);
      }
      div(v2) {
        return vec4.div(this, this, v2);
      }
      dot(v2) {
      ...
      static math(func) {
        return (...args) => {
          return vec4(func(...args.map((v2) => v2.x)), func(...args.map((v2) => v2.y)), func(...args.map((v2) => v2.z)), func(...args.map((v2) => v2.w)));
        };
      }
    ...
    vec4.floor = (v2) => vec4(Math.floor(v2.x), Math.floor(v2.y), Math.floor(v2.z), Math.floor(v2.w));
    vec4.zero = Vector4.zero;
    vec4.one = Vector4.one;
    vec4.math = Vector4.math;
    vec4.mathNonAlloc = Vector4.mathNonAlloc;
    vec4.normalize = wrapGlMatrix(import_gl_matrix2.vec4.normalize, 1, vec4.zero);
    vec4.plus = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] + b;
        out[1] = a2[1] + b;
        out[2] = a2[2] + b;
    ...
    vec4.minus = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] - b;
        out[1] = a2[1] - b;
        out[2] = a2[2] - b;
    ...
    vec4.mul = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] * b;
        out[1] = a2[1] * b;
        out[2] = a2[2] * b;
    ...
    vec4.div = wrapGlMatrix((out, a2, b) => {
      if (typeof b === "number") {
        out[0] = a2[0] / b;
        out[1] = a2[1] / b;
        out[2] = a2[2] / b;
    ...
    vec4.fill = wrapGlMatrix((out, n2) => {
      out[0] = out[1] = out[2] = out[3] = n2;
      return out;
    }, 1, vec4.zero);
    var import_gl_matrix3 = __toModule(require_cjs());
    ...
    vec2.normalize = wrapGlMatrix(import_gl_matrix3.vec2.normalize, 1, vec2.zero);
    ...
    var import_gl_matrix5 = __toModule(require_cjs());
    var import_gl_matrix4 = __toModule(require_cjs());
    ...
    var Quaternion = class extends V4Constructor2 {
      ...
      equals(v2) {
        if (!v2 || !(v2 instanceof Array))
          return false;
        return import_gl_matrix4.quat.exactEquals(this, v2);
      }
    ...
    quat.identity = wrapGlMatrix(import_gl_matrix4.quat.identity, 0, quat.create);
    quat.axisAngle = wrapGlMatrix((out, axis, rad) => import_gl_matrix4.quat.setAxisAngle(out, axis, rad), 2, quat.create);
    quat.mul = wrapGlMatrix(import_gl_matrix4.quat.mul, 2, quat.create);
    quat.invert = wrapGlMatrix(import_gl_matrix4.quat.invert, 1, quat.create);
    quat.normalize = wrapGlMatrix(import_gl_matrix4.quat.normalize, 1, quat.create);
    ...
    quat.fromEuler = wrapGlMatrix((out, angles) => import_gl_matrix4.quat.fromEuler(out, angles[0], angles[1], angles[2]), 1, quat.create);
    quat.rotate = wrapGlMatrix((out, q, v2) => import_gl_matrix4.vec3.transformQuat(out, v2, q), 2, vec3.zero);
    quat.equals = (a2, b) => {
      return import_gl_matrix4.quat.exactEquals(a2, b);
    };
    var Mat4Constructor = Array;
    var __vec4_temp = vec4.zero();
    var Matrix4x4 = class extends Mat4Constructor {
      ...
      set(m) {
        return import_gl_matrix5.mat4.set(this, ...m);
      }
      fill(n2) {
    ...
    mat4.identity = wrapGlMatrix(import_gl_matrix5.mat4.identity, 0, mat4.create);
    mat4.rts = wrapGlMatrix(import_gl_matrix5.mat4.fromRotationTranslationScale, 3, mat4.create);
    mat4.translate = wrapGlMatrix(import_gl_matrix5.mat4.translate, 2, Matrix4x4.create);
    mat4.invert = wrapGlMatrix(import_gl_matrix5.mat4.invert, 1, Matrix4x4.create);
    mat4.getTranslation = wrapGlMatrix(import_gl_matrix5.mat4.getTranslation, 1, vec3.zero);
    mat4.getRotation = wrapGlMatrix(import_gl_matrix5.mat4.getRotation, 1, quat.create);
    mat4.getScaling = wrapGlMatrix(import_gl_matrix5.mat4.getScaling, 1, vec3.zero);
    mat4.mulVec4 = wrapGlMatrix((out, m, v2) => import_gl_matrix5.vec4.transformMat4(out, v2, m), 2, vec4.zero);
    mat4.perspective = wrapGlMatrix(import_gl_matrix5.mat4.perspective, 4, Matrix4x4.create);
    mat4.transpose = wrapGlMatrix(import_gl_matrix5.mat4.transpose, 1, Matrix4x4.create);
    mat4.rotate = wrapGlMatrix((out, m, axis, rad) => import_gl_matrix5.mat4.rotate(out, m, rad, axis), 3, Matrix4x4.create);
    mat4.scale = wrapGlMatrix(import_gl_matrix5.mat4.scale, 2, Matrix4x4.create);
    mat4.fromTranslation = wrapGlMatrix(import_gl_matrix5.mat4.fromTranslation, 1, Matrix4x4.create);
    mat4.fromRotation = wrapGlMatrix(import_gl_matrix5.mat4.fromRotation, 1, Matrix4x4.create);
    mat4.fromScaling = wrapGlMatrix(import_gl_matrix5.mat4.fromScaling, 1, Matrix4x4.create);
    mat4.mul = wrapGlMatrix(import_gl_matrix5.mat4.mul, 2, Matrix4x4.create);
    mat4.add = wrapGlMatrix(import_gl_matrix5.mat4.add, 2, mat4.create);
    mat4.sub = wrapGlMatrix(import_gl_matrix5.mat4.sub, 2, mat4.create);
    mat4.plus = mat4.add;
    mat4.minus = mat4.sub;
    mat4.mulVector = wrapGlMatrix((out, m, v2) => {
      ...
      __vec4_temp[2] = v2[2];
      __vec4_temp[3] = 0;
      import_gl_matrix5.vec4.transformMat4(__vec4_temp, __vec4_temp, m);
      out[0] = __vec4_temp[0];
      out[1] = __vec4_temp[1];
      out[2] = __vec4_temp[2];
      return out;
    ...
    function simpleOrthogonal(height, aspect, near, far) {
      ...
      import_gl_matrix5.mat4.ortho(out, -aspect * height, aspect * height, -height, height, near, far);
      return out;
    }
    function orthogonal(...args) {
      ...
      const out = mat4.create();
      import_gl_matrix5.mat4.ortho(...[out, ...args]);
      return out;
    }
    ...
    mat4.equal = (a2, b) => {
      ...
      if (!(a2 instanceof Array || a2 instanceof Float32Array) || !(b instanceof Array || b instanceof Float32Array))
        return false;
      return import_gl_matrix5.mat4.exactEquals(a2, b);
    };
    mat4.set = wrapGlMatrix(import_gl_matrix5.mat4.set, 1, mat4.create);
    ...
    function allocateOutput(a2, b) {
      let length = Math.max(a2.length || 0, b.length || 0);
      switch (length) {
        case 2:
          return typeof a2 === "number" ? vec2.fill(a2) : vec2.set(a2);
        case 3:
          return typeof a2 === "number" ? vec2.fill(a2) : vec3.set(a2);
        case 4:
          return typeof a2 === "number" ? vec2.fill(a2) : vec4.set(a2);
        case 16:
    ...
    function cross(a2, b, out = vec3.zero()) {
    ...
    ***************************************************************************** */
    ...
    var DebugProvider = class {
      drawRay(origin, dir, distance2 = 1, color = Color.red, overlay = false) {
        this.drawLine(origin, mul(dir, distance2).plus(origin), color, overlay);
      }
      drawRect(...args) {
        let min, max, color;
        let overlay = false;
      ...
      drawCircle(center, radius, color = Color.red, overlay = false) {
        ...
        for (let i2 = 0; i2 < edges; i2++) {
          const p0 = vec3(Math.cos(i2 * 2 * Math.PI / edges), Math.sin(i2 * 2 * Math.PI / edges), 0);
          const p1 = vec3(Math.cos((i2 + 1) % edges * 2 * Math.PI / edges), Math.sin((i2 + 1) % edges * 2 * Math.PI / edges), 0);
...
{\r
    ...
    var Mesh = class extends Asset {
      ...
      calculateNormals(angleThreshold = 0) {
        ...
        for (let i2 = 0; i2 < this.triangles.length; i2 += 3) {
          ...
          const u = minus(b, a2);
          const v2 = minus(c, a2);
          const normal = cross(u, v2).normalize();
          vec3.plus(this.vertices[this.triangles[i2 + 0]].normal, this.vertices[this.triangles[i2 + 0]].normal, normal);
          vec3.plus(this.vertices[this.triangles[i2 + 1]].normal, this.vertices[this.triangles[i2 + 1]].normal, normal);
          vec3.plus(this.vertices[this.triangles[i2 + 2]].normal, this.vertices[this.triangles[i2 + 2]].normal, normal);
        }
        for (let i2 = 0; i2 < this.vertices.length; i2++) {
          vec3.normalize(this.vertices[i2].normal, this.vertices[i2].normal);
        }
      }
      destroy() {
        super.destroy();
    ...
    function MaterialFromShader(base_shader) {
    ...
    function createDefaultTextures(context) {
      ...
      const ctx2 = (_a = canvas2.getContext("2d")) !== null && _a !== void 0 ? _a : panic("Failed to create default texture.");
    ...
    var MeshBuilder = class {
      ...
      static cube(center = vec3.zero(), size = vec3.one(), ctx2 = GlobalContext()) {
        const verts = [
          vec3(-0.5, -0.5, -0.5).mul(size).plus(center),
          vec3(0.5, -0.5, -0.5).mul(size).plus(center),
          vec3(0.5, 0.5, -0.5).mul(size).plus(center),
          vec3(-0.5, 0.5, -0.5).mul(size).plus(center),
          vec3(-0.5, -0.5, 0.5).mul(size).plus(center),
      ...
      static sphereNormalizedCube(center = vec3.zero(), radius = 0.5, segments = 12, ctx2 = GlobalContext()) {
        ...
        for (let f = 0; f < 6; ++f) {
          for (let i2 = 0; i2 <= segments; ++i2) {
            for (let j = 0; j <= segments; ++j) {
              let vertIdx = [
                () => vec3(segments, i2, j),
                () => vec3(0, i2, segments - j),
                () => vec3(i2, j, segments),
                () => vec3(i2, segments - j, 0),
                () => vec3(i2, segments, segments - j),
                () => vec3(i2, 0, j)
              ][f]();
    ...
    function createBuiltinMesh(ctx2) {
      return {
        ...
        cube: MeshBuilder.cube(vec3.zero(), vec3.one(), ctx2)
      };
    }
    ...
    function randomInRect(rect2) {
      return vec2(Math.random(), Math.random()).mul(rect2.size).plus(rect2.min);
    }
    function random() {
    ...
    var RaindropFX2 = class {
      constructor(options) {
        ...
        const defaultOptions = {
          ...
          spawnSize: [60, 100],
          spawnLimit: 2e3,
          viewport: new Rect(vec2.zero(), vec2(canvas2.width, canvas2.height)),
          canvas: canvas2,
          width: canvas2.width,
